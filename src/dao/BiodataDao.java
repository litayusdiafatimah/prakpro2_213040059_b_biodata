...
// Mengambil koneksi dari kelas MySqlConnection di dalam paket db
import db.MySqlConnection;
// Mengambil kelas Connection dari paket java.sql
import java.sql.Connection;
// Mengambil kelas PreparedStatement dari paket java.sql
import java.sql.PreparedStatement;
// Mengambil kelas SQLException dari paket java.sql
import java.sql.SQLException;
// Mengambil kelas Statement dari paket java.sql
import java.sql.Statement;
// Mengambil kelas ResultSet dari paket java.sql
import java.sql.ResultSet;
// Mengambil kelas List dari paket java.util
import java.util.List;
// Mengambil kelas ArrayList dari paket java.util
import java.util.ArrayList;
// Mengambil kelas Biodata dari paket biodata
...
public class BiodataDao {
    ...
    public int insert(Biodata biodata) {
        ...
        try (Connection connection = MySqlConnection.getInstance().getConnection()) {
            ...
            PreparedStatement statement = connection.prepareStatement(
                    "Insert into biodata(id, nama, no_telepon, jenis_kelamin, alamat) "
                            + "values (?, ?, ?, ?, ?)");
    ...
    public Biodata select(String column, String value) {
        ...
        try (
            ...
            // Membuat ResultSet untuk menyimpan hasil dari eksekusi query
            try (ResultSet resultSet = statement.executeQuery("select * from biodata where " 
                    + column+ " = '" + value + "'");) {
                // Looping untuk mengambil semua data dari database
                while (resultSet.next()) {
                    // Set nilai dari object biodata
