...
import javax.swing.*; // Mengimpor berbagai kelas dari paket javax.swing untuk pembuatan antarmuka grafis (GUI)
import java.util.*; // Mengimpor kelas List dari paket java.util untuk penggunaan struktur data List
import dao.BiodataDao; // Mengimpor kelas BiodataDao dari paket dao
import actionlistener.HapusActionListener; // Mengimpor kelas HapusActionListener dari paket actionlistener
import actionlistener.SimpanActionListener; // Mengimpor kelas SimpanActionListener dari paket actionlistener
import actionlistener.UbahActionListener; // Mengimpor kelas UbahActionListener dari paket actionlistener
// Mengimpor kelas CloseWindowActionListener dari paket actionlistener
import actionlistener.CloseWindowActionListener; 
// Mengimpor kelas SaveToFileActionListener dari paket actionlistener
...
public class BiodataFrame extends JFrame {
    ...
    private final JButton buttonUpdate; // Variable buttonSimpanUbah untuk menangani simpan ubah
    ...
    public void showAlertAllEmpty() {
        // Tampilkan message dialog pada komponen dari parameter 1 dan 
        //pesan pada parameter 2 dengan title pada parameter 3 dan jenis pesan pada parameter 4
    ...
    public void showAlertTelephoneEmpty() {
        // Tampilkan message dialog pada komponen dari parameter 1 
       //dan pesan pada parameter 2 dengan title pada parameter 3 dan jenis pesan pada parameter 4
        JOptionPane.showMessageDialog(BiodataFrame.this, 
    ...
    public int showConfirmation(String message) {
        ...
        return JOptionPane.showConfirmDialog(BiodataFrame.this,
                "Apakah anda yakin ingin " + message + " data?", "Konfirmasi",
