...
import java.awt.event.*;// Mengimpor kelas java.awt.event untuk event handling
import biodata.BiodataFrame; // Mengambil kelas BiodataFrame dari paket biodata
import dao.BiodataDao;// Mengambil kelas BiodataDao dari paket dao
...
public class UbahActionListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        this.biodataFrame.getNamaTextField().setText(this.biodataDao.
                select(col, biodataUbah).getNama());
        ...
        this.biodataFrame.getAlamatTextField().setText(this.biodataDao
                .select(col, biodataUbah).getAlamat());
