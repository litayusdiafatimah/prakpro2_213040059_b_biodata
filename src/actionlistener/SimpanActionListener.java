...
// Mengimpor kelas java.awt.event untuk event handling
import java.awt.event.*;
// Mengimpor kelas java.util.UUID untuk menghasilkan UUID (Universally Unique Identifier)
import java.util.UUID;
import biodata.Biodata; // Mengambil kelas Biodata dari paket biodata
...
public class SimpanActionListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (nama.equalsIgnoreCase("") && telepon.equalsIgnoreCase("") 
